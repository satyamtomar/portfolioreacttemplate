...
<div class="about-me container">
  ...
  <div class="row">
    <div class="col-lg-4" data-aos="fade-right">
      <img src="assets/img/imgg10.jpg" class="img-fluid" alt=""/>
    </div>
    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
      <h3>  Web Developer/Photographer</h3>
      
      <p class="fst-italic">
        Hey I am a passionate Web Developer who loves photography.
      </p>
      <div class="row">
        <div class="col-lg-6">
          <ul>
            <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>10 Aug 2001</span></li>
            <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>https://portfolio-satyamtomar.vercel.app</span></li>
            {/* <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span></span></li> */}
            <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Dehradun</span></li>
          </ul>
        </div>
        <div class="col-lg-6">
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <strong>PhEmailone:</strong> <span>satyamtomar7777@gmail.com</span></li>
            <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>Available</span></li>
          </ul>
        </div>
      </div>
      <p>
        Currently I am doing freelancing in web development and looking for opportunities to grow as a personal both skill wise and as a human being.
      </p>
    </div>
  </div>
...
<div class="interests container">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
      <div class="icon-box">
        <i class="ri-disc-line" style={{color: "#e80368"}}></i>
        <h3>Music</h3>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 mt-4">
      <div class="icon-box">
        ...
        <h3>Going out with friends and family</h3>
      </div>
    </div>
    </div>
